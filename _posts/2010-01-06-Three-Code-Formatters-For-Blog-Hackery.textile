...
<pre class="cf" name="code">
  ...
  My personal favorite. This looks great and has nice features that allow viewers to get the code. Also, I don't have to drop out of the editor to create a code snippet.
