...
# "Download ANTLR 3.3.1":http://www.antlr.org/depot/antlr3/main/target and "Eclipse":http://www.eclipse.org/downloads/
...
* I would also like the ability to run specific tests rather than the entire test suite.
