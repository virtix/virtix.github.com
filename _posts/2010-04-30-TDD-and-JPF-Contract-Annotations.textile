...
JPF offers a declarative way to specify pre and post conditions and class invariants. Additionally, the listeners allow
for the automatic verification of the contract specification during program execution. Of course this execution can be
performed as a test run.
