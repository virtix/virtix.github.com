...
p(meta). 17 January, 2010 - Alexandria, VA, by {{page.author}}
...
_Coverage criteria_ and test design is largely what the course and the book address. After focusing on TDD, unit testing, and building a testing tool, I still have the unanswered question of "what makes a test a good test?". And how can I measure how much of component, system, object, etc., is adequately covered by my tests? I know that when I write a lot of tests and take the time to reason about what I'm doing, I know the quality of my software is better. Yet still, there's that lingering question that tests can't show the absense of bugs ... 
