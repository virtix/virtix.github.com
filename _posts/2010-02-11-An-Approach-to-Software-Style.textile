...
Following are adaptations of Strunk and White's last chapter on style as might be applied to writing software.  These are by no means _rules_, but are some guidelines that might be helpful. (I personally plan to refer back to these periodically).

h3. 1. Place yourself in the background

Users don't really care who wrote the software, only who to contact if there's a problem. So, maybe it's better to step aside, put your personality on the shelf and listen to what the software needs, not what _you_ need. 


h3. 2. Code in a way that comes naturally

There may be tones ringing in your ear that echo from various experienced programmers. They may be conflicting and cause some confusion. Listen for your voice and code in a _natural_ way. That's not to say never go beyond your comfort zone, reach, and learn something new, but rather, be true to your skill set and your software will be better for it.


h3. 3. Work from a suitable design 

Plan some before writing code. If you're writing a large complex system you'll likely need more planning, but for many smaller components, tools, and web apps, your design may be smaller. The point is to do it; to _reason_ about what you're writing and why. This should be a continuous practice. That is, you reason (design) about what you intend to do, what you are doing, and what you did.
...
h3. 6. Do not overstate

h3. 7. Avoid the use of qualifiers

h3. 8. Do not affect a breezy manner

h3. 9. Use orthodox spelling

h3. 10. Do not explain too much

h3. 11. Do not construct awkward adverbs

h3. 12. Do not explain too much

h3. 13. Make sure the reader knows who is speaking

h3. 14. Avoid fancy words

h3. 15. Do not use dialect unless your hearing is good

h3. 16. Be clear

h3. 17. Do not inject your opinion

h3. 18. Use figures of speech sparingly

h3. 19. Do not take shortcuts at the cost of clarity

h3. 20. Avoid foreign languages

h3. 21. Prefer the standard to the off-beat
